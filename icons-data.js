...
(function (root) {
  ...
  const ICONS = [
    ...
    {
      id: 'ec2', name: 'EC2', cat: 'AWS',
      prims: [
        { t: 'rrect', x: 32, y: 32, w: 36, h: 36, r: 4 },
        { t: 'rrect', x: 41, y: 41, w: 18, h: 18, r: 2 },
        { t: 'line', x1: 43, y1: 32, x2: 43, y2: 26 },
        { t: 'line', x1: 43, y1: 68, x2: 43, y2: 74 },
        { t: 'line', x1: 50, y1: 32, x2: 50, y2: 26 },
        { t: 'line', x1: 50, y1: 68, x2: 50, y2: 74 },
        { t: 'line', x1: 57, y1: 32, x2: 57, y2: 26 },
        { t: 'line', x1: 57, y1: 68, x2: 57, y2: 74 },
        { t: 'line', x1: 32, y1: 43, x2: 26, y2: 43 },
        { t: 'line', x1: 68, y1: 43, x2: 74, y2: 43 },
        { t: 'line', x1: 32, y1: 50, x2: 26, y2: 50 },
        { t: 'line', x1: 68, y1: 50, x2: 74, y2: 50 },
        { t: 'line', x1: 32, y1: 57, x2: 26, y2: 57 },
        { t: 'line', x1: 68, y1: 57, x2: 74, y2: 57 },
      ],
    },
    {
      id: 'vpc', name: 'VPC', cat: 'AWS',
      prims: [
        { t: 'rrect', x: 20, y: 28, w: 60, h: 44, r: 7 },
        { t: 'rrect', x: 30, y: 42, w: 16, h: 16, r: 2 },
        { t: 'rrect', x: 54, y: 42, w: 16, h: 16, r: 2 },
        { t: 'line', x1: 46, y1: 50, x2: 54, y2: 50 },
      ],
    },
    {
      id: 'vpc-peering', name: 'VPC Peering', cat: 'AWS',
      prims: [
        { t: 'rrect', x: 14, y: 34, w: 30, h: 30, r: 5 },
        { t: 'rrect', x: 56, y: 34, w: 30, h: 30, r: 5 },
        { t: 'circle', cx: 29, cy: 49, r: 4 },
        { t: 'circle', cx: 71, cy: 49, r: 4 },
        { t: 'line', x1: 44, y1: 49, x2: 56, y2: 49 },
        { t: 'poly', pts: [[48.39,46.6],[44,49],[48.39,51.4]] },
        { t: 'poly', pts: [[51.61,51.4],[56,49],[51.61,46.6]] },
      ],
    },
    {
      id: 'direct-connect', name: 'Direct Connect', cat: 'AWS',
      prims: [
        { t: 'rrect', x: 16, y: 38, w: 22, h: 26, r: 2 },
        { t: 'line', x1: 22, y1: 44, x2: 32, y2: 44 },
        { t: 'line', x1: 22, y1: 51, x2: 32, y2: 51 },
        { t: 'line', x1: 22, y1: 58, x2: 32, y2: 58 },
        { t: 'rrect', x: 62, y: 38, w: 22, h: 26, r: 2 },
        { t: 'line', x1: 68, y1: 44, x2: 78, y2: 44 },
        { t: 'line', x1: 68, y1: 51, x2: 78, y2: 51 },
        { t: 'line', x1: 68, y1: 58, x2: 78, y2: 58 },
        { t: 'line', x1: 38, y1: 47, x2: 62, y2: 47 },
        { t: 'line', x1: 38, y1: 55, x2: 62, y2: 55 },
        { t: 'rrect', x: 46, y: 44, w: 8, h: 14, r: 1 },
      ],
    },
    {
      id: 'interconnect', name: 'Interconnect', cat: 'AWS',
      prims: [
        { t: 'rrect', x: 40, y: 40, w: 20, h: 20, r: 4 },
        { t: 'circle', cx: 24, cy: 26, r: 5 },
        { t: 'circle', cx: 76, cy: 26, r: 5 },
        { t: 'circle', cx: 24, cy: 74, r: 5 },
        { t: 'circle', cx: 76, cy: 74, r: 5 },
        { t: 'line', x1: 41, y1: 41, x2: 28, y2: 30 },
        { t: 'line', x1: 59, y1: 41, x2: 72, y2: 30 },
        { t: 'line', x1: 41, y1: 59, x2: 28, y2: 70 },
        { t: 'line', x1: 59, y1: 59, x2: 72, y2: 70 },
      ],
    },
    {
      id: 's3', name: 'S3', cat: 'AWS',
      prims: [
        { t: 'ellipse', cx: 50, cy: 32, rx: 24, ry: 6 },
        { t: 'poly', pts: [[26,32],[33,70],[67,70],[74,32]] },
        { t: 'p', cmds: [['M',33,70],['C',40,74,60,74,67,70]] },
      ],
    },
    {
      id: 'lambda', name: 'Lambda', cat: 'AWS',
      prims: [
        { t: 'poly', pts: [[34,28],[42,28],[68,72]] },
        { t: 'poly', pts: [[52,47],[32,72]] },
      ],
    },
    {
      id: 'ecs', name: 'ECS', cat: 'AWS',
      prims: [
        { t: 'rrect', x: 24, y: 38, w: 14, h: 28, r: 2 },
        { t: 'line', x1: 24, y1: 45, x2: 38, y2: 45 },
        { t: 'rrect', x: 44, y: 38, w: 14, h: 28, r: 2 },
        { t: 'line', x1: 44, y1: 45, x2: 58, y2: 45 },
        { t: 'rrect', x: 64, y: 38, w: 14, h: 28, r: 2 },
        { t: 'line', x1: 64, y1: 45, x2: 78, y2: 45 },
      ],
    },
    {
      id: 'eks', name: 'EKS', cat: 'AWS',
      prims: [
        { t: 'polygon', pts: [[50,24],[70.33,33.79],[75.35,55.79],[61.28,73.43],[38.72,73.43],[24.65,55.79],[29.67,33.79]] },
        { t: 'circle', cx: 50, cy: 50, r: 4 },
        { t: 'line', x1: 50, y1: 50, x2: 50, y2: 24 },
        { t: 'line', x1: 50, y1: 50, x2: 70.33, y2: 33.79 },
        { t: 'line', x1: 50, y1: 50, x2: 75.35, y2: 55.79 },
        { t: 'line', x1: 50, y1: 50, x2: 61.28, y2: 73.43 },
        { t: 'line', x1: 50, y1: 50, x2: 38.72, y2: 73.43 },
        { t: 'line', x1: 50, y1: 50, x2: 24.65, y2: 55.79 },
        { t: 'line', x1: 50, y1: 50, x2: 29.67, y2: 33.79 },
      ],
    },
    {
      id: 'rds', name: 'RDS', cat: 'AWS',
      prims: [
        { t: 'ellipse', cx: 50, cy: 34, rx: 18, ry: 5 },
        { t: 'line', x1: 32, y1: 34, x2: 32, y2: 64 },
        { t: 'line', x1: 68, y1: 34, x2: 68, y2: 64 },
        { t: 'p', cmds: [['M',32,64],['C',32,72,68,72,68,64]] },
        { t: 'p', cmds: [['M',44,52],['Q',50,44,56,50]] },
        { t: 'poly', pts: [[52.02,49.65],[56,50],[54.14,46.46]] },
        { t: 'p', cmds: [['M',56,56],['Q',50,64,44,58]] },
        { t: 'poly', pts: [[47.98,58.35],[44,58],[45.86,61.54]] },
      ],
    },
    {
      id: 'dynamodb', name: 'DynamoDB', cat: 'AWS',
      prims: [
        { t: 'ellipse', cx: 50, cy: 32, rx: 18, ry: 5 },
        { t: 'line', x1: 32, y1: 32, x2: 32, y2: 66 },
        { t: 'line', x1: 68, y1: 32, x2: 68, y2: 66 },
        { t: 'p', cmds: [['M',32,66],['C',32,74,68,74,68,66]] },
        { t: 'poly', pts: [[55,38],[45,54],[51,54],[46,68]] },
      ],
    },
    {
      id: 'route53', name: 'Route 53', cat: 'AWS',
      prims: [
        { t: 'polygon', pts: [[50,24],[76,50],[50,76],[24,50]] },
        { t: 'line', x1: 40, y1: 50, x2: 60, y2: 50 },
        { t: 'poly', pts: [[54,44],[60,50],[54,56]] },
        { t: 'line', x1: 40, y1: 50, x2: 40, y2: 40 },
        { t: 'poly', pts: [[36,44],[40,40],[44,44]] },
      ],
    },
    {
      id: 'api-gateway', name: 'API Gateway', cat: 'AWS',
      prims: [
        { t: 'poly', pts: [[42,28],[34,28],[34,46],[28,50],[34,54],[34,72],[42,72]] },
        { t: 'poly', pts: [[58,28],[66,28],[66,46],[72,50],[66,54],[66,72],[58,72]] },
        { t: 'line', x1: 44, y1: 50, x2: 56, y2: 50 },
        { t: 'poly', pts: [[48.39,47.6],[44,50],[48.39,52.4]] },
        { t: 'poly', pts: [[51.61,52.4],[56,50],[51.61,47.6]] },
      ],
    },
    {
      id: 'iam', name: 'IAM', cat: 'AWS',
      prims: [
        { t: 'polygon', pts: [[50,22],[74,31],[74,52],[50,78],[26,52],[26,31]] },
        { t: 'circle', cx: 50, cy: 43, r: 7 },
        { t: 'p', cmds: [['M',39,62],['C',40,53,60,53,61,62]] },
      ],
    },
    {
      id: 'cloudwatch', name: 'CloudWatch', cat: 'AWS',
      prims: [
        { t: 'circle', cx: 50, cy: 56, r: 22 },
        { t: 'rrect', x: 45, y: 24, w: 10, h: 6, r: 1 },
        { t: 'line', x1: 50, y1: 30, x2: 50, y2: 34 },
        { t: 'line', x1: 66, y1: 34, x2: 70, y2: 30 },
        { t: 'poly', pts: [[36,56],[44,56],[48,47],[53,65],[57,56],[64,56]] },
      ],
    },
    {
      id: 'sns', name: 'SNS', cat: 'AWS',
      prims: [
        { t: 'circle', cx: 28, cy: 50, r: 7 },
        { t: 'circle', cx: 74, cy: 30, r: 5 },
        { t: 'circle', cx: 78, cy: 50, r: 5 },
        { t: 'circle', cx: 74, cy: 70, r: 5 },
        { t: 'line', x1: 35, y1: 48, x2: 69, y2: 31 },
        { t: 'line', x1: 35, y1: 50, x2: 73, y2: 50 },
        { t: 'line', x1: 35, y1: 52, x2: 69, y2: 69 },
      ],
    },
    {
      id: 'cloudformation', name: 'CloudFormation', cat: 'AWS',
      prims: [
        { t: 'rrect', x: 28, y: 30, w: 44, h: 13, r: 2 },
        { t: 'rrect', x: 28, y: 46, w: 44, h: 13, r: 2 },
        { t: 'rrect', x: 28, y: 62, w: 44, h: 13, r: 2 },
      ],
    },
  ];
